...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
    if (
        isset($_POST["garage"]) && isset($_POST["secteur"]) && isset($_POST["referance"])
    ) {

        $id_equipe = 'R' . rand(0, 1000000000000);
        $garage = $_POST['garage'];
        $secteur = $_POST['secteur'];
        $referance = $_POST['referance'];

        $stm = $cnx->prepare("INSERT INTO equipe (id_equipe, id_garage, secteur, referance) VALUES 
        ('$id_equipe','$garage','$secteur','$referance')");
        $stm->execute();
        $count = $stm->rowCount();
    }
}
...
<div class="container-fluid px-1 py-5 mx-auto">
    <div class="row d-flex justify-content-center">
        <div class="col-xl-7 col-lg-8 col-md-9 col-11 text-center">
            <h2>Ajouter une vouvelle equipe </h2>
            <div class="card">
                <form action="" method="post">
                    ...
                    <div class="row justify-content-between text-left">
                        ...
                        <div class="row justify-content-end">
                            ...
                            <div class="form-group col-sm-6">
                                <button onclick="window.location.href = 'equipe.php';" type="submit" name="retour" class="btn btn-custom">Retour</button>
                            </div>
                        </div>
                    </div>
                </form>